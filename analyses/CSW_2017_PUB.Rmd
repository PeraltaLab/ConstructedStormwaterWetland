...
#boxplots
p <- ggplot(ghg, aes(x=season, y=ch4cgm2day, color=season, shape=hydrology)) + geom_boxplot() +
  ...
  annotate("text",x=2.2,y=1.5, label="b") +
  annotate("text",x=3.2,y=1.5, label="b") +
  annotate("text",x=4.2,y=1.5, label="b") +
  annotate("text",x=0.8,y=7, label="ab") +
  annotate("text",x=1.8,y=10, label="a") + 
  annotate("text",x=2.8,y=10, label="ab") + 
  annotate("text",x=3.8,y=9, label="ab") + 
  #set plot design
  theme_bw() + 
...
ghg.ratio <- subset(ghg, co2_ch4<60000)
i <- with(ghg.ratio, interaction(hydrology,season))
ghg.lm <- lm(co2_ch4~hydrology+season+i,data=ghg.ratio)
plot(ghg.lm)
anova(ghg.lm)
#i <- with(ghg, interaction(hydrology,season))
