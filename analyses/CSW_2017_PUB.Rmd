...
sharedfile = "../data/csw2017.opti_mcc.shared"
taxfile = "../data/csw2017.opti_mcc.0.03.cons.taxonomy"
metafile = "../data/CSW_16S_design.csv"
...
plot1 <- ggplot(df1a, aes(x=V1, y=V2,  color=pcoa.shape, shape =  pcoa.col),
 ...
 ##     arrow = arrow(length = unit(0.2, "cm")),colour="black",inherit.aes=F)+ 
  ...
  xlab("PCoA 1 (17.6%)") + ylab("PCoA 2 (12.5%)") + 
  labs(shape = "Season") +
...
write.table(indicator.bac, "BacterialIndicators_treatment.txt",
...
ggsave("../figures/ch4co2Season.jpeg", plot=last_plot(), device=NULL, path=NULL, scale=1, width=6, height=4, dpi=300, limitsize=TRUE)
```
